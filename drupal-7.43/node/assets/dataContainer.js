...
ExpressionData.prototype.addNames = function(o){
...
ExpressionData.prototype._equals = function(factorA, factorB){
	for(a in factorA){		
...
ExpressionData.prototype._arrayContains = function(array, object){
	for(i in array){
...
ExpressionData.prototype.addMissingFactors = function(dataArray){
